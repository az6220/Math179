...
if __name__ == '__main__':
	...
	X_space_stacked = np.vstack((ones,X_space))
	X_space_stacked = X_space_stacked.T
	W_opt = np.linalg.solve(np.matmul(X_space_stacked.T,X_space_stacked), np.matmul(X_space_stacked.T,y_space_rand))
	"*** END YOUR CODE HERE ***"
